<div class="modal-content">
    <div class="modal-header border-bottom-0">
        <h1 class="modal-title fs-5" id="exampleModalForgotLabel">Reset my password</h1>
    ...
    <div class="modal-body pt-0">
        <form action="{{ route('register') }}" method="POST" id="form_register">
            ...
            <div class="form-outline mb-4">
                <label class="mb-form-label" for="registerEmail">Email</label>
            ...
            <div class="text-center">
                <p>Already account? <a class="link-underline-primary cus" data-bs-target="#exampleModalToggle"
                        role="button" data-bs-toggle="modal">Sign
                        in</a></p>

            </div> --}}
            <!-- Submit button -->
            <button type="submit" class="btn btn-primary btn-block mb-3"
                style="display:block;width: 50%;margin: auto">Send mail</button>
        </form>
    </div>
